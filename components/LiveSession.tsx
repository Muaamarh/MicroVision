...
import { UserInfo, LiveSubMode } from '../types';
...
const LiveSession: React.FC<LiveSessionProps> = ({ userInfo, mode, onClose, onSaveTranscript }) => {
  ...
  // Buffer for "current" turn to avoid flickering and allow fluid updates
      ...
      const sessionPromise = ai.live.connect({
        ...
        callbacks: {
          ...
          onmessage: async (msg) => {
            ...
            // Transcription handling for "fluid" typing effect
    ...
    <div className="flex-1 flex flex-col items-center justify-start p-6 space-y-4 h-full bg-slate-950 overflow-hidden">
      <div className="w-full flex justify-between items-center mb-4 z-10">
        <div className="flex items-center gap-3">
          ...
          {/* Save Button with Three Arrows on the Left */}
          <button 
            onClick={handleSave}
